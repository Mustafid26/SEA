<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        ...
        <a class="sidebar-brand brand-logo-mini" href="/redirect"><img style="width: 50px; height: auto;"
                src="{{ asset('admin/assets/images/logoserat.png') }}" alt="logo" /></a>
    </div>
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic-A" aria-expanded="false"
                aria-controls="ui-basic-A">
                <span class="menu-icon">
            ...
            <div class="collapse" id="ui-basic-A">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="{{ url('/view_pelatihan') }}">Add Pelatihan</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('/show_pelatihan') }}">Show Pelatihan</a>
                    </li>
                </ul>
            </div>
        </li>
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic-B">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="{{ url('/nilai_user') }}">Nilai Pretest User</a>
                    </li>
            ...
            <div class="collapse" id="ui-basic-C">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="{{ url('show_formpenilaian') }}">Show Form
                            Penilaian</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('show_penilaian') }}">Show Penilaian</a>
                    </li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item menu-items">
            ...
            <a class="nav-link" data-toggle="collapse" href="/logout" aria-expanded="false"
