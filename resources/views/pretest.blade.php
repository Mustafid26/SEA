...
<head>
    ...
    <style>
        ...
        /* Radio Buttons (Options) - PERBAIKAN DI SINI */
        .form-check-modern {
            display: flex;
        ...
        .card-header-modern {
            font-size: 1.8rem;
            /* Ukuran teks Pretest lebih besar */
            font-weight: 700;
            margin-bottom: 30px;
            text-align: center;
            color: white;
...
<body>
    <div class="card-modern">
        ...
        <div class="card-body">
            <form id="quizForm"
                action="{{ route('pretest.submit', ['materi_id' => $materi_id, 'kelas_id' => $kelas_id]) }}"
                method="POST">
                @csrf
                    ...
                    <div class="question @if ($key > 0) hidden @endif">
                        ...
                        <div class="space-y-3"> {{-- Tailwind class for vertical spacing --}}
                            <label class="form-check-modern">
                                ...
                                <span>{{ $question->option1 }}</span> {{-- Tambahkan span untuk teks opsi --}}
                            </label>
                            <label class="form-check-modern">
                                <input class="form-check-input-modern" type="radio"
